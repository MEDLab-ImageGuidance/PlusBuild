...
# This is added for da Vinci Xi.
IF(PLUS_USE_IntuitiveDaVinciXi)
  STRING(REPLACE ";" "|" _TMP_INCLUDE_STR "${IntuitiveDaVinciXi_INCLUDE_DIRS}")
  LIST(APPEND PLUSBUILD_ADDITIONAL_SDK_ARGS
    -DIntuitiveDaVinciXi_INCLUDE_DIRS:STRING=${_TMP_INCLUDE_STR}
	  -DIntuitiveDaVinciXi_LIBRARY_DIR:PATH=${IntuitiveDaVinciXi_LIBRARY_DIR}
	  -DIntuitiveDaVinciXi_BINARY_DIR:PATH=${IntuitiveDaVinciXi_BINARY_DIR}
	  -DPYTHON_LIBRARY_DIR:PATH=${PYTHON_LIBRARY_DIR}
...
ExternalProject_Add(PlusLib
  ...
  CMAKE_ARGS
	...
	# This is added for da Vinci Xi.
	-DPLUS_USE_IntuitiveDaVinciXi:BOOL=${PLUS_USE_IntuitiveDaVinciXi}
